...
>>>>>>> 830a6d35b... Update Rewards & Travis
=======
#error "Base Core cannot be compiled without assertions."
>>>>>>> 5d6bbaf5b... importing changes from baee coin
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
        ...
        nSubsidy = 3 * COIN;
    } else if (nHeight < 300000 && nHeight >= 120000) {
        nSubsidy = 5 * COIN;
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount, bool isZRupxStake)
{
    ...
    if (nHeight < 25000) {
        ret = blockValue / 2;
    } else if (nHeight < 80000 && nHeight >= 25000) {
        ret = blockValue * 0.6;
    } else if (nHeight < 120000 && nHeight >= 80000) {
        ret = blockValue * 0.7;
    } else if (nHeight < 170000 && nHeight >= 120000) {
        ret = blockValue * 0.6;
    } else if (nHeight < 250000 && nHeight >= 170000) {
        ret = blockValue * 0.7;
...
void static UpdateTip(CBlockIndex* pindexNew)
{
    ...
    // If turned on AutoZeromint will automatically convert BASE to zRupx
