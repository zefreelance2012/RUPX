/* src/config/rupaya-config.h.  Generated from rupaya-config.h.in by configure.  */
/* src/config/rupaya-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef RUPAYA_CONFIG_H

#define RUPAYA_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.rupx.io"
