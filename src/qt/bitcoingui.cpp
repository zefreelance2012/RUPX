...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a RUPX address"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your RUPX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified RUPX addresses"));
    ...
    openAction->setStatusTip(tr("Open a RUPX: URI or payment request"));
