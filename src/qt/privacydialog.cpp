...
void PrivacyDialog::on_pushButtonZPivControl_clicked()
{
    ...
    ZPivControlDialog* zRupxControl = new ZPivControlDialog(this);
...
void PrivacyDialog::updateSPORK16Status()
{
    ...
    if (fMaintenanceMode && fButtonsEnabled) {
        ...
        ui->pushButtonMintzRupx->setToolTip(tr("PrivacyDialog", "Enter an amount of RUPX to convert to zRupx", 0));
